...
const NumberCell: React.FC<NumberCellProps> = ({ value, isSelected, isHint, isPossibleMatch, onClick, id }) => {
  ...
  if (value === null) {
    ...
    selectionStyles = "bg-yellow-100 text-yellow-800 animate-pulse";
  }

  // Highlight possible matches with a light blue border as requested
